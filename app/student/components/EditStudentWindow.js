...
export default class EditStudentWindow {
  ...
  constructor(options) {
    ...
    var levelComboBox = new LevelComboBox({value: student.tingkat});
    var stambukLamaTextBox = new TextBox({value: student.stambuk_lama, height: 25, width: '100%'});
    var stambukBaruTextBox = new TextBox({value: student.stambuk_baru, height: 25, width: '100%'});
    var nameTextBox = new TextBox({value: student.nama, height: 25, width: '100%'});
